/**
 * Mobile icon set — thin wrapper over lucide-react-native.
 *
 * Same purpose as `./web.tsx`: app code should always import icons from
 * here, never from lucide-react-native directly, so stroke width/size stay
 * consistent and swapping the icon library later is a one-file change.
 *
 * Keep the semantic names in sync with `./web.tsx` — same name, same
