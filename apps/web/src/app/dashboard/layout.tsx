...
import { IconAnalytics, IconDocument, IconBuilding, IconClients, IconChat, IconHeart } from "@repo/icons/web";
...
const NAV: DashboardNavItem[] = [
  ...
  { href: "/dashboard/favorites", label: "Saved listings", icon: IconHeart },
